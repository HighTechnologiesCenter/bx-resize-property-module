...
namespace HtcCs\CustomPropertiesModule\CustomProperties;

use Bitrix\Main\Localization\Loc;
use HtcCs\CustomPropertiesModule\Helpers\ImageProcessingHelper;
 ...
 * @package HtcCs\CustomPropertiesModule\CustomProperties
 */
class PictureResizerUserTypeProperty extends \CUserTypeFile
{
    ...
    public function GetSettingsHTML($userFieldParameters = false, $htmlControlName, $valuesFromForm)
    {
        ...
        <tr>
            ...
            <td>
                <input type="text" name="' . $htmlControlName['NAME'] . '[SIZE]" size="20"
                    maxlength="20" value="' . $sizeValue . '"
                />
            </td>
        </tr>
        ';
        ...
        <tr>
            ...
            <td>
                <input type="text" name="' . $htmlControlName['NAME'] . '[LIST_WIDTH]" size="7"  maxlength="20"
                    value="' . $widthValue . '"
                />
                &nbsp;x&nbsp;
                <input type="text" name="' . $htmlControlName['NAME'] . '[LIST_HEIGHT]" size="7"  maxlength="20"
                    value="' . $heightValue . '"
                />
            </td>
        </tr>
        ...
        <tr>
            <td>' . Loc::getMessage('USER_TYPE_FILE_MAX_SHOW_SIZE') . ':</td>
                <td>
                <input type="text" name="' . $htmlControlName['NAME'] . '[MAX_SHOW_SIZE]" size="20"  maxlength="20"
                    value="' . $maxShowSizeValue . '"
                />
            </td>
        </tr>
        ';
        ...
        <tr>
            ...
            <td>
                <input type="text" name="' . $htmlControlName['NAME'] . '[MAX_ALLOWED_SIZE]" size="20"  maxlength="20"
                    value="' . $maxAllowedSizeValue . '"
                    />
            </td>
        </tr>
        ';
        ...
        if ($valuesFromForm) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="20" name="' . $htmlControlName['NAME'] . '[EXTENSIONS]"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="' . $htmlControlName['NAME'] . '[RESIZE_HEIGHT]" size="20"  maxlength="20"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="' . $htmlControlName['NAME'] . '[RESIZE_WIDTH]" size="20"  maxlength="20"
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="' . $htmlControlName['NAME'] . '[USE_CROP]"
                    value="Y" ' . $useCropCheckedAttribute . '
                />
            </td>
        </tr>
        ';
    ...
    function OnBeforeSave($userFieldParameters, $value)
    {
        if (is_array($value)) {
            ...
            if ($value['error']) {
                ...
                if ((empty($userFieldParameters['SETTINGS']['RESIZE_HEIGHT']))
                    && (empty($userFieldParameters['SETTINGS']['RESIZE_WIDTH']))
                ) {
    ...
    private static function getResizedPicture($userFieldParameters, $value, \CFile $bitrixFileService)
    {
        ...
        $sizes = ImageProcessingHelper::processResizeSizes(
